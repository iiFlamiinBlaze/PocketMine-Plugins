...
class MinigamesTransfer extends PluginBase implements Listener{
    ...
    public function onPlayerInteract(PlayerInteractEvent $event){
        /**
         * On interact of the MinigamesTransfer Item
         */
        ...
        if($sender instanceof Player){
            ...
            if($inv->contains(Item::get(369,0,1))){
                ...
                $event->getPlayer()->teleport($this->getServer()->getLevelByName("minigames")->getSafeSpawn());
                $inv->removeItem(Item::get (369,0,1));
            }
        }
        return true;
    }
