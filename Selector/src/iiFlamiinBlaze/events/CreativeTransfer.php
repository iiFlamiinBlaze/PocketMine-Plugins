...
class CreativeTransfer extends PluginBase implements Listener{
    ...
    public function onPlayerInteract(PlayerInteractEvent $event){
        /**
         * On interact of the CreativeTransfer Item
         */
        ...
        if($sender instanceof Player){
            ...
            if($inv->contains(Item::get(418,0,1))){
                ...
                $event->getPlayer()->teleport($this->getServer()->getLevelByName("creative")->getSafeSpawn());
                $inv->removeItem(Item::get (418,0,1));
            }
        }
    }
}
